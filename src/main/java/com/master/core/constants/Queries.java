...
public abstract class Queries {
        ...
        public static final String INSERT_EMAILER_DATA = "INSERT INTO tbl_prefunded_emailers (type,subject,is_active,partnered_claim_no,pf_request_id,policy_no,claim_no) "
                        + " VALUES(:type, :subject, :is_active, :partnered_claim_no, :pf_request_id, :policy_no, :claim_no)";

        public static final String INSERT_EMAILER_ITEMS_BY_TPA_DESK_ID = "INSERT INTO tbl_prefunded_emailer_items (tpa_desk_id, claim_no, policy_no, initial_amt_req, initial_amt_approved, final_adj_amt_req, final_adj_amt_approved, patient_name, metadata, pf_emailer_id) "
                        + " VALUES(:tpa_desk_id, :claim_no, :policy_no, :initial_amt_req, :initial_amt_approved, :final_adj_amt_req, :final_adj_amt_approved, :patient_name, :metadata, :pf_emailer_id)";
